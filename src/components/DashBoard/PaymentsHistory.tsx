      ...
      <div className="overflow-auto my-5 max-h-80 p-2">
        <table className="min-w-full border relative">
          <thead className="bg-white border-b sticky -top-3">
            <tr>
              <th className="text-sm font-medium text-gray-900 p-3 text-left">#</th>
              <th className="text-sm font-medium text-gray-900 p-3 text-left">Date</th>
              <th className="text-sm font-medium text-gray-900 p-3 text-left">Trx ID</th>
              <th className="text-sm font-medium text-gray-900 p-3 text-left">Service</th>
              <th className="text-sm font-medium text-gray-900 p-3 text-left">Amount</th>
          ...
          <tbody>
            {userBookings &&
              ...
              userBookings.map((booking: Booking, index) => (
                <tr
                  key={booking._id}
